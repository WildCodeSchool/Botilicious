...
const Chatbots = {
  ...
  messagePost(req, res) {
    ...
    // chercher la phrase next
    findNext(splitMessage, req)
      .then((nextSentence) => {
        console.log('nextSentence: ', nextSentence);
