keyword// delete sur une phrase : requête http en delete, puis effacer la ligne du tableau dans la page
...
$('#addkeyword').click(function(){
  ...
  function(data, status){
    ...
    if (!data.error){
      ...
      $('#keywords').append('<tr id="keyword'+data.keywords.id+'"><td id="keywordtext'+data.keywords.id+'">'+data.keywords.text+'</td><td>'+data.keywords.id+'</td><td><button id=deletekeyword'+data.keywords.id+'>Supprimer</button></td></tr>');
